    ...
    <div className="page-shell" style={{ alignItems: "stretch", maxWidth: "1300px", margin: "0 auto" }}>
      <div className="page-header">
        ...
        <p style={{ color: "#6b7280", maxWidth: "720px", margin: "0 auto", fontSize: "14px", lineHeight: "1.6" }}>
          Торговый шлюз Victimok Labs. Цены с пометкой «от» — нижняя полка DNS, где модель есть в каталоге, иначе крупная розница РФ (М.Видео, МТС, Citilink, ASUS Store) на сентябрь 2026. Apple в DNS.ру нет. FPV и лаборатория — наши работы, не витрина DNS.
        </p>
      </div>
