      ...
      groups: [
        {
          ...
          items: [
            { name: "Карбоновая рама повышенной жесткости 5\\\"", price: "от 3 500 ₽" },
            { name: "Карбоновая рама 7\\\" / 10\\\" + титановый крепеж", price: "от 4 500 ₽" },
            ...
            { name: "Готовый FPV-комплекс 7\\\" под ключ (рама, тяга, стек, камера)", price: "от 35 000 ₽" }
          ]
        },
        {
