      ...
      <div className="cyber-terminal home-terminal">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "50px", textAlign: "left", marginBottom: "60px" }}>
          <div className="home-dept">
            <div style={{ color: "#00f2ff", fontFamily: "monospace", fontSize: "12px", marginBottom: "15px", overflowWrap: "anywhere" }}>[ DEPARTMENT_ALPHA // HIGH_LEVEL_SOFTWARE_OVERLORD ]</div>
            <h3 style={{ color: "#fff", fontSize: "clamp(18px, 4vw, 24px)", margin: "0 0 20px 0", fontWeight: 800 }}>ГЛОБАЛЬНЫЙ МНОГОЯЗЫКОВОЙ ПРОГРАММНЫЙ ИНЖИНИРИНГ</h3>
          ...
          <div className="home-dept">
            <div style={{ color: "#00f2ff", fontFamily: "monospace", fontSize: "12px", marginBottom: "15px", overflowWrap: "anywhere" }}>[ DEPARTMENT_BRAVO // HARDCORE_SILICON_SURGERY ]</div>
            <h3 style={{ color: "#fff", fontSize: "clamp(18px, 4vw, 24px)", margin: "0 0 20px 0", fontWeight: 800 }}>КЛИНИЧЕСКАЯ РЕАНИМАЦИЯ ЭЛЕКТРОНИКИ И МИКРОЭЛЕКТРОННЫЙ АНАЛИЗ</h3>
            <p style={{ color: "#9ca3af", fontSize: "14px", lineHeight: "1.7" }}>
          ...
          <div className="home-dept">
            <div style={{ color: "#00f2ff", fontFamily: "monospace", fontSize: "12px", marginBottom: "15px", overflowWrap: "anywhere" }}>[ DEPARTMENT_GAMMA // AEROSPACE_FPV_WARFARE ]</div>
            <h3 style={{ color: "#fff", fontSize: "clamp(18px, 4vw, 24px)", margin: "0 0 20px 0", fontWeight: 800 }}>АВИОНИКА, БЕСПИЛОТНЫЕ КОМПЛЕКСЫ И КАНАЛЫ СВЯЗИ FPV</h3>
            <p style={{ color: "#9ca3af", fontSize: "14px", lineHeight: "1.7" }}>
