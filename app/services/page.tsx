  ...
  const deepServices = [
    {
      ...
      color: "#00f2ff",
      description: "Проектирование и развертывание высоконагруженных систем. Мы принципиально исключили низкоуровневую залупу (Assembly/машинные коды) и оперируем масштабируемыми макро-абстракциями, гарантирующими реактивность и отказоустойчивость контуров.",
      groups: [
        {
